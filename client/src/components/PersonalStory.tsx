...
export default function PersonalStory() {
  ...
  return (
    <div className="bg-secondary/5 border-2 border-secondary/20 rounded-2xl p-6 md:p-8">
      ...
      <div className="space-y-4 text-lg leading-relaxed">
        ...
        {isExpanded && (
          <div id="personal-story-full" className="space-y-4 mt-4 pt-4 border-t-2 border-secondary/20">
            <p className="text-foreground">
            ...
            <p className="text-foreground font-semibold text-center mt-6 flex items-center justify-center gap-2">
              אז בוא נתחיל. ביחד.
        ...
        <div className="flex justify-center mt-6">
          <Button
            ...
            className="text-secondary hover:text-secondary hover:bg-secondary/10 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
        ...
        {/* Call to action */}
        {!isExpanded && (
          <div className="text-center mt-6 pt-6 border-t-2 border-secondary/20">
