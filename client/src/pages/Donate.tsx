    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-blue-50 p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="p-6 mb-8 bg-white">
          <h2 className="text-xl font-bold text-foreground mb-4">למה התרומות עוזרות?</h2>
        ...
        <div className="space-y-6 mb-8">
          <h2 className="text-2xl font-bold text-foreground text-center">דרכי תרומה</h2>

          {/* Bit / Paybox */}
          <Card className="p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              <Smartphone className="h-8 w-8 text-secondary flex-shrink-0" />
              <div className="flex-1">
                <h3 className="text-xl font-bold text-foreground mb-2">Bit או Paybox</h3>
                <p className="text-muted-foreground mb-3">הדרך הכי פשוטה - ישירות מהאפליקציה</p>
                <div className="bg-secondary/5 rounded-lg p-4 border-2 border-secondary/20">
                  <p className="text-sm text-muted-foreground mb-1">מספר טלפון:</p>
                  <p className="text-2xl font-bold text-secondary dir-ltr">053-303-0931</p>
                </div>
                <Button
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-3">תרומה בינלאומית דרך PayPal</p>
                <div className="bg-primary/5 rounded-lg p-4 border-2 border-primary/20">
                  <p className="text-sm text-muted-foreground mb-1">קישור PayPal:</p>
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-foreground mb-2">העברה בנקאית</h3>
                <p className="text-muted-foreground mb-3">העברה ישירה לחשבון הבנק</p>
                <div className="bg-purple-50 rounded-lg p-4 border-2 border-purple-200 space-y-2">
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <span className="font-bold text-foreground">לאומי (10)</span>
                    
                    <span className="text-muted-foreground">סניף:</span>
                    <span className="font-bold text-foreground">944</span>
                    
                    <span className="text-muted-foreground">חשבון:</span>
                    <span className="font-bold text-foreground">50148816</span>
                    
                    <span className="text-muted-foreground">ע.מ:</span>
                    <span className="font-bold text-foreground">313320129</span>
                  </div>
                  <div className="pt-2 border-t border-purple-200">
                    <p className="text-sm text-muted-foreground">על שם:</p>
                    <p className="font-bold text-foreground">אור דרורי - תרומות לאתר "עזרה לזולת"</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-bold text-foreground mb-2">מזומן</h3>
                <p className="text-muted-foreground mb-3">מעדיפים למסור ביד? בואו נתאם</p>
                <div className="bg-orange-50 rounded-lg p-4 border-2 border-orange-200">
                  <p className="text-sm text-muted-foreground mb-1">צרו קשר בוואטסאפ:</p>
        ...
        {/* Thank You */}
        <Card className="p-8 mb-8 bg-gradient-to-r from-secondary/10 to-primary/10 border-2 border-secondary/20">
