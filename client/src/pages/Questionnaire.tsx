      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="text-center">
          <p className="text-lg text-muted-foreground">
            <Clock className="inline w-4 h-4" /> 2-3 דקות • עד {totalSteps} שאלות פשוטות
          </p>
        </div>
        ...
        {currentStep === 5 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-center text-muted-foreground">
              <Lightbulb className="inline w-4 h-4" /> זה עוזר לנו למצוא תוכניות שמתאימות בדיוק לכם
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { value: 'under-5000', label: 'פחות מ-5,000 ₪', icon: 'Coins' },
                { value: '5000-10000', label: '5,000-10,000 ₪', icon: 'Coins' },
                { value: '10000-15000', label: '10,000-15,000 ₪', icon: 'Coins' },
                { value: '15000-20000', label: '15,000-20,000 ₪', icon: 'Coins' },
                { value: 'over-20000', label: 'מעל 20,000 ₪', icon: 'Coins' }
              ].map((option) => (
                <Card
                  key={option.value}
        ...
        {currentStep === 6 && answers.hasChildren === 'yes' && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-center text-muted-foreground">
              <Lightbulb className="inline w-4 h-4" /> לדוגמה: 3, 7, 12 (הפרידו בפסיקים)
            </p>
        ...
        {currentStep === 7 && answers.housing === 'rent' && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-center text-muted-foreground">
              <Lightbulb className="inline w-4 h-4" /> זה עוזר לנו למצוא סיוע בדיור
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { value: 'under-2000', label: 'פחות מ-2,000 ₪', icon: 'Home' },
                { value: '2000-4000', label: '2,000-4,000 ₪', icon: 'Home' },
                { value: '4000-6000', label: '4,000-6,000 ₪', icon: 'Home' },
                { value: 'over-6000', label: 'מעל 6,000 ₪', icon: 'Home' }
              ].map((option) => (
                <Card
                  key={option.value}
                  className="p-6 cursor-pointer hover:bg-accent hover:border-primary transition-all"
        ...
        {currentStep === 8 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-center text-muted-foreground">
              <Lightbulb className="inline w-4 h-4" /> יש תוכניות ספציפיות לגילאים שונים
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                { value: 'under-25', label: 'מתחת ל-25', icon: 'User' },
                { value: '25-40', label: '25-40', icon: 'User' },
                { value: '40-60', label: '40-60', icon: 'User' },
                { value: 'over-60', label: 'מעל 60', icon: 'User' }
              ].map((option) => (
                <Card
                  key={option.value}
                  className="p-8 cursor-pointer hover:bg-accent hover:border-primary transition-all"
